{- A large stream blocks your path. According to the locals, it's not safe to cross
   ...
   there are zero or more other things, separated by commas: either another group
   or garbage. Since groups can contain other groups, a } only closes the most recently
   opened unclosed group - that is, they are nestable. Your puzzle input represents
