...
part1 instructions =
    numChars instructions - numChars (List.map decode instructions)


part2 : List String -> Int
part2 instructions =
    numChars (List.map encode instructions) - numChars instructions
...
numChars =
    List.foldl (\s -> \len -> String.length s + len) 0
