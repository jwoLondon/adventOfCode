...
See [knotHash.md](knotHash.md) for details of the knot hash process. It is moved to a separate document because [day 14](d14_2017.md) also uses knot hashing.
...
part1 =
    let
        ...
        ol =
            knot (OffsetList 0 0 (List.range 0 255)) lengths
    in
...
See [knotHash.md](knotHash.md) for details.
