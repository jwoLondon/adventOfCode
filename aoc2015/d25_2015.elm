{- Merry Christmas! Santa is booting up his weather machine; looks like you might
   ...
   generated. The first code is 20151125. After that, each code is generated by
   taking the previous one, multiplying it by 252533, and then keeping the remainder
   ...
   that by 33554393, which leaves a remainder of 31916031. That remainder is the
   second code.
...
part1 input =
    parse input
        |> nAt
        |> modularExp 20151125 252533 33554393
...
modularExp : Int -> Int -> Int -> Int -> Int
