...
```elm {l}
getKeys : AOC.Grid Char -> Dict Char AOC.GridLocation
getKeys =
...
```elm {l}
startLocation : AOC.Grid Char -> AOC.GridLocation
startLocation =
    AOC.gMapWithLocation
        (\loc c ->
            if c == '@' then
...
findDependencies :
    AOC.Grid Char
    -> AOC.GridLocation
    -> Set AOC.GridLocation
    -> Dict Char AOC.GridLocation
    -> List Char
    -> Set ( Char, List Char )
    -> Set ( Char, List Char )
        ...
        case AOC.gGet ( row, col ) g of
            Just cell ->
                if Dict.member cell keysLeft then
                    ...
                    findDependencies (AOC.gSet ( row, col ) '.' g)
                        ( row, col )
                        visited
                        keysLeft
